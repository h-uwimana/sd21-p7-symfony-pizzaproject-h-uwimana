 ...
 */
final class Version20230322130512 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bestelling_product (bestelling_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_D73B86FA4584665A (product_id), INDEX IDX_D73B86FAA2E63037 (bestelling_id), PRIMARY KEY(bestelling_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
