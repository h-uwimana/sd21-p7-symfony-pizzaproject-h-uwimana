 ...
 */
final class Version20230311144204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD small NUMERIC(5, 2) NOT NULL, ADD meduim NUMERIC(5, 2) NOT NULL, ADD large NUMERIC(5, 2) NOT NULL, CHANGE price price DOUBLE PRECISION NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP small, DROP meduim, DROP large, CHANGE price price NUMERIC(5, 2) NOT NULL');
    }
}
